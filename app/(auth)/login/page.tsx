            ...
            <div className="mt-6">
              ...
              <div className="mt-4 space-y-3">
                ...
                <button
                  ...
                  disabled={loading || googleLoading || linkedinLoading}
                  className="w-full flex items-center justify-center gap-3 rounded-lg border border-gray-300 px-4 py-3 text-base font-semibold text-white shadow-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  style={{ backgroundColor: '#0077B5' }}
                  onMouseOver={(e) => !loading && !googleLoading && !linkedinLoading && (e.currentTarget.style.backgroundColor = '#006399')}
